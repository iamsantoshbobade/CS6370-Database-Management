...
/*        //Pranav - For Testing purpose
        out.println ();
        Table t_select3 = movie.select (t ->  t[movie.col("studioName")] == "Fox");
        t_select3.print ();
        //Pranav - Testing Ends here
*/
        //--------------------- indexed select: key
...
/*        //Pranav - For Testing purpose
        out.println ();
        Table t_iselect2 = movieStar.select (new KeyType ("Carrie_Fisher"));
        t_iselect2.print ();
        //Pranav - Testing Ends here
*/
...
/*        //Pranav - For Testing purpose
        out.println ();
        Table t_union2 = cinema.union (movie);
        t_union2.print ();
        //Pranav - Testing Ends here
*/
 ...
 /*       //Pranav - For Testing purpose
        out.println();
        Table t_minus2= cinema.minus(movie);
        t_minus2.print ();
        //Pranav - Testing Ends here
*/
        ...
        //Pranav - For Testing purpose
        //out.println ();
        //Table t_join3 = movie.join ("producerNo", "producerNo", cinema);
        //t_join3.print ();
        //Pranav - Testing Ends here
        ...
        //Pranav - For Testing purpose
        //out.println ();
        //Table t_join4 = movie.join (movieStar);
        //t_join4.print ();
        //Pranav - Testing Ends here
