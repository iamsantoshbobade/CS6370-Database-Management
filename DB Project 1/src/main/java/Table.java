...
public class Table implements Serializable {
	...
	public Table project(String attributes) {
        ...
        {
        		//System.out.println("--------------M Y T E S T I N G-----------------------------------");
	...
	public Table select(KeyType keyVal) {
        ...
        Comparable[] keyTuple = index.get(keyVal);
        rows.add(keyTuple);
        //Code written ends
    ...
    public Table join (String attributes1, String attributes2, Table table2)
    {
        ...
        Integer[] index1=new Integer[t_attrs.length];
        Integer[] index2=new Integer[t_attrs.length];
        int k1=0;
        int k=0;
        List <Comparable []> rows = new ArrayList <> ();
        for(int i=0;i<t_attrs.length;i++){
        	index1[i]=col(t_attrs[i]);  //Find Index Positions of attributes in a table 
        }//for
        
        for(int j=0;j<u_attrs.length;j++){
        	index2[j]=table2.col(u_attrs[j]); //Find Index Positions of attributes in a table 
       ...
       String[] tup1=new String[tuples.size()];
        ...
        Comparable[] temp1;
         int flag=0;
         /*
          * Compare element of tuple at given position of table1 with table2
          * and store matching tuple in rows list 
          * 
          */
         for(int i=0;i<tuples.size();i++){
         ...
         /*
          * return new table with output in List rows
          * 
          */
    ...
    public Table join (Table table2)
    {
        ...
        for(int i=0;i<commonattr.size();i++){
        	index1[i]=col(commonattr.get(i)); //Find Index Positions of attributes in a table 
        
        	
        }//for
        
        for(int j=0;j<commonattr.size();j++){
        	index2[j]=table2.col(commonattr.get(j));//Find Index Positions of attributes in a table 
            
        }//for
        /*
         * Compare elements of tuples of common attributes
         *  and add common tuples in rows1 list
         */
        int flag=0;
        for(int i=0;i<tuples.size();i++){
          Comparable[] tup=tuples.get(i);
        ...
        */
        ...
        for(Comparable[] c:rows1){
          ...
          */
         return new Table (name + count++,attr,ArrayUtil.concat (domain, table2.domain), key, rows);
  } // join
    		...
    		//System.out.println("length is equal");
    	         for(int i=0;i<t.length;i++){
    	        	// System.out.println("Inside For Loop");
    	        	 //System.out.println("doamin-->"+domain[i]+"--->"+t[i].getClass());
    	        	 if(domain[i].equals(t[i].getClass())){
